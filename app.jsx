    ...
    <div className="min-h-screen bg-slate-50 text-[#7A7A7A] font-sans selection:bg-[#E0218A] selection:text-white">
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="md:w-2/5 flex justify-center relative">
               <div className="relative w-64 h-64 md:w-80 md:h-80">
                  <div className="absolute inset-0 bg-gradient-to-tr from-pink-400 to-purple-500 rounded-full blur-2xl opacity-40 animate-pulse"></div>
                  <img 
                    src={profilePic} 
                    alt="Krysta McAlister" 
                    className="relative w-full h-full object-cover rounded-full border-4 border-white shadow-2xl"
                  />
                  <div className="absolute -bottom-6 -right-6 bg-white p-4 rounded-xl shadow-lg border border-slate-100 animate-bounce-slow">
                     <span className="text-4xl">💻</span>
                     <span className="font-bold text-slate-800 ml-2 font-playfair">Full Stack</span>
                  </div>
               </div>
            </div>
          </div>
      ...
      <section id="experience" className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 max-w-5xl">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-black mb-4 font-playfair">Experience</h2>
            <div className="w-24 h-1 bg-[#E0218A] mx-auto rounded-full"></div>
          </div>
    ...
    <div className="h-full flex flex-col">
          ...
          >
             <div className="h-full flex flex-col lg:flex-row p-8 lg:p-12 gap-10 items-center overflow-y-auto">
                ...
                <div className="w-full lg:w-1/2">
                   <h3 className="text-3xl font-playfair font-bold text-black mb-6 border-l-4 border-[#E0218A] pl-4">
                     {slide.title}
                   </h3>
      ...
      <div className="p-6 bg-white border-t border-pink-100 flex justify-between items-center">
        <div className="flex gap-2">
           {slides.map((_, idx) => (
             <div 
               ...
               className={`h-2 rounded-full transition-all cursor-pointer ${idx === currentIndex ? 'w-8 bg-[#E0218A]' : 'w-2 bg-pink-200'}`}
             ></div>
           ))}
        </div>
        <div className="flex gap-4">
          <button 
            onClick={prevSlide}
            className="p-3 rounded-full border border-pink-200 text-[#E0218A] hover:bg-pink-50 transition-colors"
          >
            <ChevronLeft size={24} />
          </button>
          <button 
             onClick={nextSlide}
             className="px-6 py-3 rounded-full bg-[#E0218A] text-white font-bold shadow-lg shadow-pink-200 hover:bg-pink-600 transition-transform active:scale-95 flex items-center gap-2"
          >
